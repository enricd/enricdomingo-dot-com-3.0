...
function BackgroundCircles({}: Props) {
  return (
    ...
    >
      <div className="absolute border-2 border-[#333333] rounded-full h-[200px] w-[200px] mt-64 animate-ping"/>
      ...
      <div className="absolute border-2 border-[#10a78d] opacity-20 rounded-full h-[650px] w-[650px] mt-64 animate-pulse"/>
